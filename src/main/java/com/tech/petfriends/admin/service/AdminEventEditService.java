...
public class AdminEventEditService implements AdminServiceInterface {
    ...
    public void execute(Model model) {
        try {
            ...
            String thumbnailName = thumbnail != null && !thumbnail.isEmpty() ? saveFile(thumbnail, new File(uploadDir, "thumbnail")) : null;
            String slideImgName = slideImg != null && !slideImg.isEmpty() ? saveFile(slideImg, new File(uploadDir, "slideImg")) : null;
