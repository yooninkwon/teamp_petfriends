...
public class AdminProductModifyService implements AdminServiceInterface {
...
//		adminProductDao.adminProductAdd(proCode,proName,petType,proType,proDetailType,filterType1,filterType2,proDiscount,productStatus);
		...
		MultipartFile[] removeImages = (MultipartFile[]) model.getAttribute("removeImages"); // 상세 이미지
		
		System.out.println(removeImages+"삭제된이미지");
