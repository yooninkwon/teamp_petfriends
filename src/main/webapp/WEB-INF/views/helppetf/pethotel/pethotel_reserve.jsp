	...
	<div class="container">
		...
		<div class="popup-form" id="popup-form" style="display: none;">
			...
			<form id="pet-form">
				...
				<label>종</label> 
				<input type="radio" id="pet-type" name="pet-type" value="고양이" class="radio_button"> 고양이 
				<input type="radio" id="pet-type" name="pet-type" value="강아지" class="radio_button"> 강아지 
				
				<label for="birth-date">생일</label> 
				<input name="pet-birth-date" type="date" id="pet-birth-date">
				
				<label>성별</label> 
				<input type="radio" id="pet-gender" name="pet-gender" value="M" class="radio_button"> M 
				<input type="radio" id="pet-gender" name="pet-gender" value="F" class="radio_button"> F 
				
				<label for="weight">체중</label>
				<input name="pet-weight" type="number" id="pet-weight" placeholder="Kg">
				
				<label>중성화</label> 
				<input type="radio" id="pet-neutered" name="pet-neutered" value="Y" class="radio_button"> Y 
