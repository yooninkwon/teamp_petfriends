...
<div class="info-container">
	...
	<form action="/mypage/updateMember" method="post" class="memberinfo">
	    <div class="form-row">
	    ...
	    <div class="form-row">
	        <label for="phoneNumberDisabled">휴대전화</label>
	        <input type="number" id="phoneNumberDisabled" value="${loginUser.mem_tell}" disabled>
	        <span class="modify-text" onclick="openPhoneNumberChange()">변경하기</span>
	        <!-- <span id="phoneNumberError" class="error-msg">올바른 형식의 번호를 입력해주세요.</span> -->
	    </div>
	    ...
	    <div class="form-row">
	        ...
	        <span id="birthError" class="error-msg"></span>
	    </div>
	    ...
	    <div class="form-row">
	        ...
	        <c:forEach var="address" items="${address}">
                <c:if test="${address.addr_default.toString() == 'Y'}">
                    <input type="text" id="address" value="${address.addr_line1} ${address.addr_line2}" disabled>
