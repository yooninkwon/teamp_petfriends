...
<body>
	...
	<div class="slider">
		<div class="slides">
			<!-- 각 슬라이드 -->
			<div class="slide">
				<img src="<c:url value='/static/Images/MainImg/event1.png'/>"
					alt="Event 1">
			</div>
			<div class="slide">
				<img src="<c:url value='/static/Images/MainImg/event2.png'/>"
					alt="Event 2">
			</div>
			<div class="slide">
				<img src="<c:url value='/static/Images/MainImg/event3.png'/>"
					alt="Evemt 3">
			</div>
		</div>
		<!-- 화살표버튼 -->
	...
	<div id="best_product_table">
		<c:forEach var="list" items="${dogList}">
			<div class="bestProductItem" data-product-code="${list.pro_code}"
				...
				<span class="bestProName">${list.pro_name}</span>  
				<span id="bestProPrice"> <fmt:formatNumber
